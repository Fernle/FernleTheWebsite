// Gamer Page JavaScript
class GamerPage {
    constructor() {
        this.games = [];
        this.currentSort = 'alphabetical';
        this.isAdmin = false;
        this.adminPassword = 'fernle2024'; // Change this to your desired password
    ...
    setupEventListeners() {
        ...
        // Show login modal (you can trigger this with a secret key combination)
    ...
    checkAdminStatus() {
        const adminStatus = localStorage.getItem('gamer-admin');
        if (adminStatus === 'true') {
            this.isAdmin = true;
    ...
    handleLogin(e) {
        ...
        if (password === this.adminPassword) {
            this.isAdmin = true;
            localStorage.setItem('gamer-admin', 'true');
            this.showAdminSection();
            this.hideLoginModal();
    ...
    handleLogout() {
        this.isAdmin = false;
        localStorage.removeItem('gamer-admin');
    ...
    handleAddGame(e) {
        ...
        if (imageUrl) {
            ...
            // For file upload, we'll use a placeholder or convert to base64
            // In a real implementation, you'd upload to a server
            this.showNotification('File upload not supported in demo. Please use image URL.', 'error');
            return;
        } else {
    ...
    saveGamesToStorage() {
        // In a real implementation, this would make an API call to save to a database
        // For now, we'll use localStorage as a temporary solution
        localStorage.setItem('gamer-games', JSON.stringify(this.games));
    }

    loadGamesFromStorage() {
        const stored = localStorage.getItem('gamer-games');
        if (stored) {
